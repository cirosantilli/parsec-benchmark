...
Then I got tired of debugging useless netapps, and the next failure is x264:

....
Unknown option --build=x86_64-pc-linux-gnu, ignored
./configure: line 179: ./config.sub: No such file or directory
